        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Menu_Categories_IdCategory",
            ...
            migrationBuilder.InsertData(
                table: "Menu",
                columns: new[] { "Id", "IdCategory", "Image", "Name", "Price" },
                values: new object[,]
                {
                    { "P01", "C05", "~/images_icon/menu/list_menu/mn1.jpg", "Espresso", 50.25f },
                    { "P02", "C02", "~/images_icon/menu/list_menu/mn2.jpg", "Latte Macchiato", 50.25f },
                    { "P03", "C01", "~/images_icon/menu/list_menu/mn3.jpg", "Capuchino", 50.25f },
                    { "P04", "C04", "~/images_icon/menu/list_menu/mn4.jpg", "Coffee Latte", 50.25f },
                    { "P05", "C07", "~/images_icon/menu/list_menu/mn5.jpg", "Coffee Mocha", 50.25f },
                    { "P06", "C02", "~/images_icon/menu/list_menu/mn6.jpg", "Americano", 50.25f },
                    { "P07", "C06", "~/images_icon/menu/list_menu/mn7.jpg", "Espresso Con Panna", 50.25f },
                    { "P08", "C01", "~/images_icon/menu/list_menu/mn8.jpg", "Capuchino Viennese", 50.25f }
                });
